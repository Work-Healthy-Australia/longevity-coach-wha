...
import { updateAgentDefinition, addMCPServer, removeMCPServer, toggleAgent } from "./actions";
import { createAdminClient } from "@/lib/supabase/admin";
import { redirect } from "next/navigation";

// Server component wrapper loads data; inner form is client
export { AgentEditPage as default };
