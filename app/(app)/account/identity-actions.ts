...
export async function updateIdentity(
  ...
  try {
    ...
    console.error("[updateIdentity] uncaught error:", err);
    const message =
      err instanceof Error ? err.message : "Unexpected error saving profile.";
    return { error: `Save failed: ${message}`, values: submitted };
  }
}
